...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container1").wowSlider({effect:"fly",prev:"",next:"",duration:25*100,delay:25*100,width:638,height:360,autoPlay:true,stopOnHover:true,loop:false,bullets:1,caption:false,captionEffect:"slide",controls:true,logo:"engine1/loading.gif",onBeforeStep:0,images:0});